...
{
    ui_screen_imageresultpage = lv_obj_create(NULL);
    ...
    ui_imageresultpage_label_back1 = lv_label_create(ui_imageresultpage_panel_backpannel1);
    lv_obj_set_width(ui_imageresultpage_label_back1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_imageresultpage_label_back1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_imageresultpage_label_back1, 10);
    lv_obj_set_y(ui_imageresultpage_label_back1, 5);
    lv_obj_set_align(ui_imageresultpage_label_back1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_imageresultpage_label_back1, "Back");

    ui_imageresultpage_image_image8 = lv_image_create(ui_imageresultpage_panel_backpannel1);
    lv_image_set_src(ui_imageresultpage_image_image8, &ui_img_img_back_png);
    lv_obj_set_width(ui_imageresultpage_image_image8, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_imageresultpage_image_image8, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_imageresultpage_image_image8, -27);
    lv_obj_set_y(ui_imageresultpage_image_image8, 5);
    lv_obj_set_align(ui_imageresultpage_image_image8, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_imageresultpage_image_image8, LV_OBJ_FLAG_CLICKABLE);     /// Flags
    lv_obj_remove_flag(ui_imageresultpage_image_image8, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_width(ui_imageresultpage_container_container7, 183);
    lv_obj_set_height(ui_imageresultpage_container_container7, 111);
    lv_obj_set_x(ui_imageresultpage_container_container7, 1);
    lv_obj_set_y(ui_imageresultpage_container_container7, 9);
    lv_obj_set_align(ui_imageresultpage_container_container7, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_imageresultpage_container_container7, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_remove_flag(ui_imageresultpage_container_container7,
                       LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_imageresultpage_spinner_spinner2 = lv_spinner_create(ui_imageresultpage_container_container7);
    //lv_spinner_set_anim_params(ui_imageresultpage_spinner_spinner2, 1000, 90);
    lv_obj_set_width(ui_imageresultpage_spinner_spinner2, 58);
    lv_obj_set_height(ui_imageresultpage_spinner_spinner2, 61);
    lv_obj_set_x(ui_imageresultpage_spinner_spinner2, 0);
    lv_obj_set_y(ui_imageresultpage_spinner_spinner2, -26);
    lv_obj_set_align(ui_imageresultpage_spinner_spinner2, LV_ALIGN_CENTER);
    lv_obj_remove_flag(ui_imageresultpage_spinner_spinner2, LV_OBJ_FLAG_CLICKABLE);      /// Flags

    ui_imageresultpage_label_label36 = lv_label_create(ui_imageresultpage_container_container7);
    lv_obj_set_width(ui_imageresultpage_label_label36, 180);
    lv_obj_set_height(ui_imageresultpage_label_label36, 55);
    lv_obj_set_x(ui_imageresultpage_label_label36, 3);
    lv_obj_set_y(ui_imageresultpage_label_label36, 35);
    lv_obj_set_align(ui_imageresultpage_label_label36, LV_ALIGN_CENTER);
    lv_label_set_text(ui_imageresultpage_label_label36, "y56y56y56y56y56y56y56y56y56y56y56y56y56y56y56y");
    ...
    lv_obj_add_event_cb(ui_imageresultpage_panel_backpannel1, ui_event_imageresultpage_panel_backpannel1, LV_EVENT_ALL,
                        NULL);
    uic_Screen_ImageResultPage = ui_screen_imageresultpage;
